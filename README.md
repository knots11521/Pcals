...
Download the latest pre-built Windows package from the PCALS release page:

[**⬇️ Download PCALS for Windows**](https://github.com/knots11521/Pcals/releases/tag/v.1)

After downloading:

1. Open the **Assets** section of the release.
2. Download the Windows `.zip` package.
3. Extract the ZIP file to a folder of your choice.
4. Double-click `pcals.exe` to launch the application.
5. Follow the on-screen installer to set up the database connection.
